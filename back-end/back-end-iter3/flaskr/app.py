...
threedim_ip='http://192.168.43.243:5005'
...
###重建部分开始
@app.route('/prepare_30', methods=['POST', 'GET'])
def prepare_30():
    import datetime
...
@app.route('/getpictures_30',methods=['POST','GET'])
def getpictures_30():
    # 检查请求中是否包含文件
    print(request.files)
    if 'file' not in request.files:
...
@app.route('/shot_30/<filename>', methods=['GET','POST'])
def shot_30(filename):
    image_path = 'test/' + filename
    url = threedim_ip+'/pic30'
...
@app.route('/confirm_all', methods=['GET','POST'])
def confirm_all():

    url = threedim_ip+'/confirm'
...
@app.route('/prepare_31', methods=['POST', 'GET'])
def prepare_31():
    import datetime
...
@app.route('/getpictures_31',methods=['POST','GET'])
def getpictures_31():
    # 检查请求中是否包含文件
    print(request.files)
    if 'file' not in request.files:
...
@app.route('/shot_31/<filename>', methods=['GET','POST'])
def shot_31(filename):
    image_path = 'test/' + filename
    url = threedim_ip+'/pic31'
...
@app.route('/prepare_32', methods=['POST', 'GET'])
def prepare_32():
    import datetime
...
@app.route('/getpictures_32',methods=['POST','GET'])
def getpictures_32():
    # 检查请求中是否包含文件
    print(request.files)
    if 'file' not in request.files:
...
@app.route('/shot_32/<filename>', methods=['GET','POST'])
def shot_32(filename):
    image_path = 'test/' + filename
    url = threedim_ip+'/pic32'
...
@app.route('/prepare_33', methods=['POST', 'GET'])
def prepare_33():
    import datetime
...
@app.route('/getpictures_33',methods=['POST','GET'])
def getpictures_33():
    # 检查请求中是否包含文件
    print(request.files)
    if 'file' not in request.files:
...
@app.route('/shot_33/<filename>', methods=['GET','POST'])
def shot_33(filename):
    image_path = 'test/' + filename
    url = threedim_ip+'/pic33'
...
@app.route('/prepare_34', methods=['POST', 'GET'])
def prepare_34():
    import datetime
...
@app.route('/getpictures_34',methods=['POST','GET'])
def getpictures_34():
    # 检查请求中是否包含文件
    print(request.files)
    if 'file' not in request.files:
...
@app.route('/shot_34/<filename>', methods=['GET','POST'])
def shot_34(filename):
    image_path = 'test/' + filename
    url = threedim_ip+'/pic34'
